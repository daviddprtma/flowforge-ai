...
import { SlackIcon, BasecampIcon } from '../nodes/NodeIcons';
import { useCredentialList, useDeleteCredential } from '../../hooks/useCredentials';
import { startGoogleOAuth, checkGoogleConfig, startSlackOAuth, checkSlackConfig, startBasecampOAuth, checkBasecampConfig } from '../../api/client';
        ...
        <div className="flex items-center gap-3 px-5 py-4 border-b border-slate-200 dark:border-slate-700 shrink-0">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[11px] text-slate-400 dark:text-slate-500 mt-0.5">
              Manage credentials for Google Workspace, Slack, and Basecamp integrations.
            </p>
          </div>
