...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: 'Add Nodes',
    description: 'Click here to browse all available node types — triggers, AI models, REST API calls, Google apps, Slack, and more.',
    placement: 'right',
  ...
  },
  {
    ...
    title: 'Credentials',
    description: 'Connect your Google Workspace, Slack, and Basecamp accounts to use inside your workflows.',
    placement: 'bottom',
