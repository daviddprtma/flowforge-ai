...
export async function oauthRoutes(
    ...
    options: { googleAuth: GoogleAuthService; slackAuth: SlackAuthService; basecampAuth: BasecampAuthService; credentialRepo: CredentialRepository }
): Promise<void> {
    const { googleAuth, slackAuth, basecampAuth, credentialRepo } = options;
