...
async function bootstrap() {
    ...
    const pollingService = new PollingService(
        ...
        basecampAuth, slackAuth, googleAuth,
    );
    ...
    const triggerTestService = new TriggerTestService(googleAuth, slackAuth, basecampAuth);
    ...
    await fastify.register(oauthRoutes,          { prefix: '/api', googleAuth, slackAuth, basecampAuth, credentialRepo });
