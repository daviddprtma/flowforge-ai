/**
 * Shared FlowForge AI email templates.
 *
 * Used by:
...
/**
 * Wraps arbitrary body content in the FlowForge AI branded email shell.
 *
...
export function buildFluxMessageHtml(subject: string, bodyContent: string, isHtml = true): string {
    ...
    const fromName = process.env.SMTP_FROM_NAME ?? 'FlowForge AI';
